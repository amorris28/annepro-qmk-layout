...
*/
 ...
 [_BASE_LAYER] = KEYMAP( /* Base */
    ...
    KC_LCTL, KC_LGUI, KC_FN1_LAYER, KC_SPC, LT(_FN2_LAYER,KC_LEFT), LT(_LALT,KC_DOWN), LT(_RALT,KC_UP), RCTL_T(KC_RGHT)
),
  /*
  * Layer _FN1_LAYER
  * ,-----------------------------------------------------------------------------------------.
 ...
 [_FN1_LAYER] = KEYMAP( /* Base */
    ...
    MO(_FN2_LAYER), KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_NO, KC_TRNS,
    KC_CAPS, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MNXT, KC_VOLU, KC_VOLD, KC_MPLY
),
  /*
  * Layer _FN2_LAYER
  * ,-----------------------------------------------------------------------------------------.
 ...
 [_FN2_LAYER] = KEYMAP( /* Base */
    ...
    KC_DEL, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS, KC_TRNS,
